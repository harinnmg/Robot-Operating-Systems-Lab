Create three folders inside your package named, launch, rviz and urdf
Inside urdf folder, start a new text file with extension .urdf
Copy and paste the following code to the text file
```
<?xml version="1.0"?>
<robot name="myfirst">
  <link name="base_link">
...
```
Create a text file inside the launch folder with extension .launch and paste the following code
```
<launch>

  <arg name="model" default="$(find my_robot_description)/urdf/mytest.urdf"/>
  <arg name="gui" default="true" />
  <arg name="rvizconfig" default="$(find my_robot_description)/rviz/myurdf.rviz" />
...
```
Create a text file in the rviz folder with extension .rviz and paste the following code
```
Panels:
  - Class: rviz/Displays
	Help Height: 78
